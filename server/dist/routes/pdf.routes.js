...
function createPdfRoutes(repos) {
    const router = (0, express_1.Router)();
    router.use(auth_js_1.authenticate);
    router.get('/invoice/:id', (0, auth_js_1.authorize)('invoices:read'), async (req, res) => {
        try {
...
function generateInvoiceHtml(invoice, client, clientName) {
